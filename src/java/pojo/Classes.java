...
public class Classes implements java.io.Serializable {
    ...
    public String toString() {
        return "Classes{" + "idClasses=" + idClasses + ", exercise=" + exercise + ", classesName=" + classesName + ", duration=" + duration + ", slots=" + slots + ", images=" + images + '}';
    }
...
//    }
    ...
    public Classes(int idClasses, Exercise exercise, String classesName, String duration, int slots) {
